...
#include <memory>
#include "../../gui_source/networktimestamp/ntpclient.h"
...
QT_MOC_LITERAL(1, 10, 11), // "ntpFinished"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 9), // "_ntpStart"
QT_MOC_LITERAL(4, 33, 10), // "onNTPStart"
QT_MOC_LITERAL(5, 44, 14), // "onNtpConnected"
QT_MOC_LITERAL(6, 59, 14), // "onNtpReadyRead"
QT_MOC_LITERAL(7, 74, 10), // "onNtpError"
QT_MOC_LITERAL(8, 85, 28) // "QAbstractSocket::SocketError"

    },
    "NTPClient\0ntpFinished\0\0_ntpStart\0"
    "onNTPStart\0onNtpConnected\0onNtpReadyRead\0"
    "onNtpError\0QAbstractSocket::SocketError"
};
...
void NTPClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ntpFinished(); break;
        case 1: _t->_ntpStart(); break;
        case 2: _t->onNTPStart(); break;
        case 3: _t->onNtpConnected(); break;
        case 4: _t->onNtpReadyRead(); break;
        case 5: _t->onNtpError((*reinterpret_cast< QAbstractSocket::SocketError(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (NTPClient::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NTPClient::ntpFinished)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (NTPClient::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NTPClient::_ntpStart)) {
                *result = 1;
                return;
            }
        }
